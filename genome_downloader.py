...
#                        for file_id in fil:
#                        print file_id
                        print "Downloading %s from %s via urrlib at %s" % (fil, pwd + "/" + str(key) + "/" + str(annoying_folders[key]) + str(annoying_folders[key[genome_subfolders[key[fil]]]]), datetime.datetime.now())
